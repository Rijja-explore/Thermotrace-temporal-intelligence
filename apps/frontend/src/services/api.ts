...
export interface ThermoEvent {
  ...
  facility_context?: {
    ...
    nearby_refinery_km?: number | null;
    land_cover?: string | null;
    population_within_5km?: number | null;
    is_within_facility_boundary?: boolean | null;
    source?: string | null;
    [key: string]: any;
  };
  landcover_context?: {
    primary_class?: string | null;
    urban_builtup_pct?: number | null;
  ...
  satellite_context?: {
    imagery_available?: boolean | null;
    source?: string | null;
  ...
  temporal_features?: {
    window_7d?: { detection_count?: number; frp_mean?: number; persistence_ratio?: number; [key: string]: any };
    window_30d?: { detection_count?: number; frp_mean?: number; persistence_ratio?: number; [key: string]: any };
    window_90d?: { detection_count?: number; frp_mean?: number; persistence_ratio?: number; [key: string]: any };
  ...
  baseline?: {
    ...
    normal_detection_frequency_per_month?: number | null;
    normal_intensity_mean?: number | null;
    normal_intensity_std?: number | null;
    normal_active_hours?: number[] | null;
    normal_spatial_extent_m?: number | null;
    baseline_period_days?: number | null;
    history_quality?: string | null;
    [key: string]: any;
  };
  deviation?: {
    frp_deviation_pct?: number | null;
    frequency_deviation_pct?: number | null;
  ...
  anomaly?: {
    ...
    is_abnormal: boolean;
    frp_zscore?: number | null;
    frequency_zscore?: number | null;
    spatial_shift_m?: number | null;
  ...
  analyst_review?: {
    ...
    reclassified_label?: string | null;
    notes?: string | null;
