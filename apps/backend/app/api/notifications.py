...
DISPATCH_HISTORY: List[Dict[str, Any]] = [
    {
        ...
        "recipient_name": "Anagesh V (Thermal Analyst)",
        "role": "ANALYST",
    ...
    },
    {
        ...
        "recipient_name": "Rijja M (Emergency Response Official)",
        "role": "OFFICIAL",
...
def dispatch_notification(
    ...
    for t in targets:
        ...
        record = {
            ...
            "channel": "EMAIL",
            "recipient": t["email"],
            "recipient_name": "Rijja M (Official)" if t["role"] == "OFFICIAL" else "Anagesh V (Analyst)",
            "role": t["role"],
            "subject": subject,
            "status": "DISPATCHED",
