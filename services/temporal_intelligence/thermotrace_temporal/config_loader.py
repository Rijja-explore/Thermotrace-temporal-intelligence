...
_PROJECT_ROOT_CONFIG = Path(__file__).resolve().parent.parent.parent.parent / "config"
_SERVICE_CONFIG = Path(__file__).resolve().parent.parent.parent / "config"
_DEFAULT_CONFIG_DIR = _PROJECT_ROOT_CONFIG if _PROJECT_ROOT_CONFIG.exists() else _SERVICE_CONFIG
